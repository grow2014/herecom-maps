 ...
 *
 * @author Andrew.Gahov@gmail.com  (2017-03-21)
 */
        ...
        mapFragment.init(new OnEngineInitListener() {
            ...
            public void onEngineInitializationCompleted(OnEngineInitListener.Error error) {
                if (error == OnEngineInitListener.Error.NONE) {
                    ...
                    // Set the map center to the Taganrog region (no animation)
                    map.setCenter(new GeoCoordinate(47.213918, 38.911724, 0.0),
                            Map.Animation.NONE);
